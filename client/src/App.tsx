          ...
          <BrowserRouter>
            <Switch>
              <Route
                ...
                path="/"
                component={() => (
                  <Login member={member} setMember={setMember} token={token} />
                )}
              ></Route>
              <Route
                path="/email"
                component={() => (
                  <AuthEmail member={member} setMember={setMember} />
                )}
              ></Route>
              <Route
                path="/personalInfo"
          ...
          <BrowserRouter>
            <Switch>
              ...
              <Route
                ...
                component={() => <Locker member={member} />}
              ></Route>
              <Route
                path="/mypage"
                component={() => <MyPage member={member} />}
              ></Route>
              <Route
                path="/myuse"
                component={() => <MyUse member={member} />}
              ></Route>
              <Route
                path="/qna"
                component={() => <QnA member={member} />}
              ></Route>
              <Route
                path="/guide"
                component={() => <Guide member={member} />}
              ></Route>
              <Route
                path="/setting"
              ...
              <Route
                path="/qrcode"
                component={() => <QrCode member={member} />}
              ></Route>
              <Route
                path="/pay"
                component={() => <Pay member={member} />}
              ></Route>
              <Route
                path="/payComplete"
                component={() => <PayComplete member={member} />}
              ></Route>
            </Switch>
          </BrowserRouter>
        </div>
